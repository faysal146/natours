...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"../ajax/axios.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js"}],"../component/alert.js":[function(require,module,exports) {
"use strict";
...
var hideAlert = function hideAlert(type, meg) {
...
var showAlert = function showAlert() {
  ...
  var meg = arguments.length > 1 ? arguments[1] : undefined;
  hideAlert();
  var markUp = "<div class=\"alert alert--".concat(type, "\">").concat(meg, "</div>");
...
exports.default = _default;
},{}],"../component/loader.js":[function(require,module,exports) {
"use strict";
...
function showLoader(selelctor) {
  var el = document.querySelector(selelctor);
  el.disabled = true;
...
module.exports = exports.default;
module.exports.default = exports.default;
},{"./util/assertString":"../../node_modules/validator/lib/util/assertString.js"}],"account.js":[function(require,module,exports) {
"use strict";
...
var _axios = _interopRequireDefault(require("../ajax/axios"));

var _alert = _interopRequireDefault(require("../component/alert"));

var _loader = require("../component/loader");
...
var updateData = document.getElementById('update-info');
var updatePassword = document.getElementById('update-password');
var userPhoto = document.querySelector('#photo');

var updataAjax = function updataAjax(_ref) {
  var path = _ref.path,
      formData = _ref.formData,
      message = _ref.message;
  (0, _loader.showLoader)("#update-".concat(path.endsWith('account') ? 'info' : 'password', " button"));
  return _axios.default.patch(path, formData).then(function (res) {
    if (res.data.status === 'success') {
      window.location.assign('/account');
      (0, _alert.default)('success', message);
    } else {
    ...
    (0, _loader.hideLoader)();
    (0, _alert.default)('error', err.response.data.message);
  });
};
...
var updateUserData = function updateUserData(e) {
  e.preventDefault();
  var name = document.querySelector('#update-info #name').value;
  var email = document.querySelector('#update-info #email').value;
  var photo = document.querySelector('#photo').files[0];

  if (name === '') {
    (0, _alert.default)('error', 'Enter name');
  } else if (!/^[a-zA-Z ]+$/.test(name)) {
    (0, _alert.default)('error', 'name only contain alpha characters');
  } else if (!(0, _isEmail.default)(email)) {
    (0, _alert.default)('error', 'Please provide valid email address');
  } else {
...
var updateUserPassword = function updateUserPassword(e) {
  e.preventDefault();
  var currentPassword = document.querySelector('#password-current').value;
  var password = document.querySelector('#password').value;
  var confirmPassword = document.querySelector('#password-confirm').value;

  if (currentPassword === '' || password === '' || confirmPassword === '') {
    (0, _alert.default)('error', 'Enter Password');
  } else if (!(0, _isLength.default)(password, {
    min: 8
  })) {
    (0, _alert.default)('error', 'Password should be 8 characters');
  } else if (password !== confirmPassword) {
    (0, _alert.default)('error', 'Password does not match');
  } else {
    ...
    updataAjax(options).then(function (res) {
      if (res.data.status === 'success') {
