...
exports.default = _default;
},{}],"../dependencies/stripe.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _axios.default.get("bookings/checkout-session/".concat(tourId)).then(function (session) {
              stripe.redirectToCheckout({
                sessionId: session.data.session.id
              });
            }).catch(function (err) {
              (0, _alert.default)('error', err);
            });
...
exports.default = _default;
},{"../ajax/axios":"../ajax/axios.js","../component/alert":"../component/alert.js"}],"../dependencies/mapbox.js":[function(require,module,exports) {
"use strict";
...
var _stripe = _interopRequireDefault(require("../dependencies/stripe"));

var _mapbox = _interopRequireDefault(require("../dependencies/mapbox"));
...
var starButton = document.querySelectorAll('.cta__rating svg');
(0, _mapbox.default)(JSON.parse(displayMap.dataset.location));

if (bookingButton) {
  bookingButton.addEventListener('click', function (e) {
    e.target.textContent = 'Proccessing...';
    (0, _loader.showLoader)(".".concat(e.target.classList[1]));
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","tour.js"], null)
