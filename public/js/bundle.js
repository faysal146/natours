...
var showAlert = function showAlert(type, meg) {
  hideAlert();
...
function postLoginData(email, password) {
  _axios.default.post('http://localhost:3000/api/v1/users/login', {
    ...
    if (data.data.status === 'success') {
      (0, _alert.default)('success', 'You are now Loggin');
    }
    ...
    return (0, _alert.default)('error', err.response.data.message);
  });
}
...
function logout() {
  _axios.default.get('http://localhost:3000/api/v1/users/logout').then(function (res) {
    console.log(res);
...
},{"axios":"../node_modules/axios/index.js","./alert":"alert.js"}],"updataUserData.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.default)('success', 'account info updating...');
            } else {
              (0, _alert.default)('error', 'something went wrong....');
            }
...
function _upDatePassword() {
  _upDatePassword = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(currentPassword, password, confirmPassword) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.patch('http://localhost:3000/api/v1/users/update-password', {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              window.location.reload();
              (0, _alert.default)('success', 'password is changed');
            } else {
              (0, _alert.default)('error', 'something went wrong....');
            }
...
var stripe = Stripe('pk_test_5PIDjXVc65gEiEwA6BzBkjNs00xV5NEMHB');
...
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("http://localhost:3000/api/v1/bookings/checkout-session/".concat(tourId));
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.default)('error', _context.t0);
  ...
  return function getSessionData(_x) {
    return _ref.apply(this, arguments);
  };
}();

var _default = getSessionData;
exports.default = _default;
...
var _updataUserData = require("./updataUserData");
...
var bookingButton = document.getElementById('booking-btn');
...
if (loginForm) {
  loginForm.addEventListener('submit', _login.default);
}
...
if (upDatePasswordForm) {
  upDatePasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var btnSavePass = document.querySelector('#update-password-form .btn');
    btnSavePass.textContent = 'Updateing...';
    var currPass = document.querySelector('#update-password-form #password-current').value;
    var pass = document.querySelector('#update-password-form #password').value;
    var newPass = document.querySelector('#update-password-form #password-confirm').value;
    (0, _updataUserData.upDatePassword)(currPass, pass, newPass).then(function (res) {
